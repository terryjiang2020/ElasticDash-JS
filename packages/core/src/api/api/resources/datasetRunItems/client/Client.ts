...
export class DatasetRunItems {
   ...
   */
  public create(
    request: ElasticDashAPI.CreateDatasetRunItemRequest,
    requestOptions?: DatasetRunItems.RequestOptions,
  ): core.HttpResponsePromise<ElasticDashAPI.DatasetRunItem> {
  ...
  private async __create(
    request: ElasticDashAPI.CreateDatasetRunItemRequest,
    requestOptions?: DatasetRunItems.RequestOptions,
  ): Promise<core.WithRawResponse<ElasticDashAPI.DatasetRunItem>> {
    ...
    if (_response.ok) {
      return {
        data: _response.body as ElasticDashAPI.DatasetRunItem,
   ...
   */
  public list(
    request: ElasticDashAPI.ListDatasetRunItemsRequest,
    requestOptions?: DatasetRunItems.RequestOptions,
  ): core.HttpResponsePromise<ElasticDashAPI.PaginatedDatasetRunItems> {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __list(
    request: ElasticDashAPI.ListDatasetRunItemsRequest,
    requestOptions?: DatasetRunItems.RequestOptions,
  ): Promise<core.WithRawResponse<ElasticDashAPI.PaginatedDatasetRunItems>> {
    ...
    if (_response.ok) {
      return {
        data: _response.body as ElasticDashAPI.PaginatedDatasetRunItems,
        rawResponse: _response.rawResponse,
      };
    }
