...
export class Score {
   ...
   */
  public create(
    request: ElasticDashAPI.CreateScoreRequest,
    requestOptions?: Score.RequestOptions,
  ): core.HttpResponsePromise<ElasticDashAPI.CreateScoreResponse> {
  ...
  private async __create(
    request: ElasticDashAPI.CreateScoreRequest,
    requestOptions?: Score.RequestOptions,
  ): Promise<core.WithRawResponse<ElasticDashAPI.CreateScoreResponse>> {
    ...
    if (_response.ok) {
      return {
        data: _response.body as ElasticDashAPI.CreateScoreResponse,
