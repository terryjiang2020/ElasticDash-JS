...
export const ELASTICDASH_TRACER_NAME = "elasticdash-sdk";
...
export enum ElasticDashOtelSpanAttributes {
  ...
  // Compatibility - Map properties that were documented in https://elasticdash.com/docs/opentelemetry/get-started#property-mapping,
