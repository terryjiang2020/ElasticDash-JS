...
This is the OTEL package of the ElasticDash JS SDK containing the `LangfuseSpanProcessor` to export emitted spans to ElasticDash with masking, filtering, and media handling.
