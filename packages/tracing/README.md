...
This is the tracing package of the ElasticDash JS SDK containing the instrumentation methods for instrumenting your LLM app such as `startActiveSpan`, `startActiveGeneration`, and the `observe` wrapper.
...
- Docs: https://github.com/ElasticDash/elasticdash-doc
